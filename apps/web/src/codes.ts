...
export const controlCodes: ControlCodeItem[] = [
  ...
  { type: "CSI", code: "J", mnemonic: "ED", description: "erase", params: { "0": "from cursor to end of screen", "1": "from cursor to beginning of screen", "2": "entire screen", "3": "saved lines (xterm)" }, defaults: { mode: "0" } },
  ...
  { type: "CSI", code: "s", mnemonic: "SCP/DECSLRM", description: "save cursor (mode 69 off) or set left/right margins (mode 69 on)", template: "left <left>, right <right>", example: { left: "1", right: "80" }, defaults: { left: "1", right: "screen width" } },
