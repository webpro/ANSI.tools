...
export const ansiCodes: AnsiCode[] = [
  ...
  { type: "ESC", code: "7", mnemonic: "SC", description: "save cursor position" },
  { type: "ESC", code: "8", mnemonic: "RC", description: "restore cursor position" },
  ...
  { type: "CSI", code: "S", mnemonic: "SU", description: "scroll up", template: "<n>", example: { n: "1" } },
  { type: "CSI", code: "T", mnemonic: "SD", description: "scroll down", template: "<n>", example: { n: "1" } },
  ...
  { type: "DEC", code: "2", mnemonic: "DECANM", description: "ANSI/VT52 mode" },
  { type: "DEC", code: "3", mnemonic: "DECCOLM", description: "132 column mode" },
  { type: "DEC", code: "4", mnemonic: "DECSCLM", description: "scrolling mode" },
  { type: "DEC", code: "5", mnemonic: "DECSCNM", description: "reverse light/dark screen mode" },
  { type: "DEC", code: "6", mnemonic: "DECOM", description: "origin mode" },
  { type: "DEC", code: "7", mnemonic: "DECAWM", description: "auto-wrap mode" },
  { type: "DEC", code: "8", mnemonic: "DECARM", description: "auto-repeat mode" },
  { type: "DEC", code: "9", description: "X10 mouse reporting" },
  { type: "DEC", code: "12", description: "start blinking cursor" },
  { type: "DEC", code: "25", mnemonic: "DECTCEM", description: "show text cursor" },
  ...
  { type: "DEC", code: "1034", description: "8-bit meta-key mode" },
  { type: "DEC", code: "1035", description: "numeric meta-key lock mode" },
  { type: "DEC", code: "1036", description: "alternate key modifiers mode" },
  { type: "DEC", code: "1037", description: "delete is DEL key mode" },
  { type: "DEC", code: "1039", description: "alternate backspace mode" },
  { type: "DEC", code: "1042", description: "bell is urgent mode" },
  { type: "DEC", code: "1043", description: "save meta in alternate mode" },
  { type: "DEC", code: "1047", description: "alternate screen mode" },
  { type: "DEC", code: "1048", description: "save extended cursor mode" },
  { type: "DEC", code: "1049", description: "alternate screen buffer (with cursor save/restore)" },
  { type: "DEC", code: "1050", description: "set termcap/terminfo special keys" },
  ...
  { type: "OSC", code: "17", mnemonic: "OSC 17", description: "set selection background color", template: ";<color>", example: { color: "#ff0000" } },
  { type: "OSC", code: "19", mnemonic: "OSC 19", description: "set selection foreground color", template: ";<color>", example: { color: "#0000ff" } },
