...
export const controlCodes: ControlCodeItem[] = [
  ...
  { type: "CSI", code: "L", mnemonic: "IL", description: "insert lines", template: "<n> lines", example: { n: "1" } },
  { type: "CSI", code: "M", mnemonic: "DL", description: "delete lines", template: "<n> lines", example: { n: "1" } },
  { type: "CSI", code: "P", mnemonic: "DCH", description: "delete characters", template: "<n> chars", example: { n: "1" } },
  { type: "CSI", code: "S", mnemonic: "SU", description: "scroll up (pan down)", template: "<rows> rows", example: { rows: "1" } },
  { type: "CSI", code: "T", mnemonic: "SD", description: "scroll down (pan up)", template: "<rows> rows", example: { rows: "1" } },
  { type: "CSI", code: "t", description: "window manipulation" },
  { type: "CSI", code: "X", mnemonic: "ECH", description: "erase characters", template: "<n> chars", example: { n: "1" } },
  { type: "CSI", code: "Z", mnemonic: "CBT", description: "cursor backward tabulation", template: "<n> tabs", example: { n: "1" } },
  { type: "CSI", code: "`", mnemonic: "HPA", description: "horizontal position absolute", template: "col <col>", example: { col: "1" } },
  { type: "CSI", code: "a", mnemonic: "HPR", description: "horizontal position relative", template: "<cols> cols", example: { cols: "1" } },
  ...
  { type: "CSI", code: "d", mnemonic: "VPA", description: "vertical position absolute", template: "row <row>", example: { row: "1" } },
  { type: "CSI", code: "e", mnemonic: "VPR", description: "vertical position relative", template: "<rows> rows", example: { rows: "1" } },
  { type: "CSI", code: "f", mnemonic: "HVP", description: "horizontal vertical position", template: "row <row>, col <col>", example: { row: "1", col: "1" } },
  ...
  { type: "CSI", code: "j", mnemonic: "HPB", description: "horizontal position backward", template: "<cols> cols", example: { cols: "1" } },
  { type: "CSI", code: "k", mnemonic: "VPB", description: "vertical position backward", template: "<rows> rows", example: { rows: "1" } },
  ...
  { type: "CSI", code: " q", mnemonic: "DECSCUSR", description: "set cursor style", template: "style <style>", example: { style: "2" } },
