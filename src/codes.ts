...
export const controlCodes: ControlCodeItem[] = [
  ...
  { type: "SGR", code: "38;2", description: "set fg color (24-bit true color)", template: ";<colorspace>;<r>;<g>;<b>", example: { colorspace: "0", r: "255", g: "105", b: "180" }, defaults: { colorspace: "0" } },
  ...
  { type: "SGR", code: "48;2", description: "set bg color (24-bit true color)", template: ";<colorspace>;<r>;<g>;<b>", example: { colorspace: "0", r: "255", g: "105", b: "18" }, defaults: { colorspace: "0" } },
  { type: "SGR", code: "48;5", description: "set bg color (256-color palette)", template: ";<n>", example: { n: "198" } },
  { type: "SGR", code: "58;2", description: "set underline color (24-bit true color)", template: ";<colorspace>;<r>;<g>;<b>", example: { colorspace: "0", r: "255", g: "105", b: "18" }, defaults: { colorspace: "0" } },
  ...
  { type: "CSI", code: "G", mnemonic: "CHA", description: "move cursor character absolute", template: "col <col>", example: { col: "1" }, defaults: { col: "1" } },
  ...
  { type: "CSI", code: "R", mnemonic: "CPR", description: "cursor position report", template: "row <row>, col <col>", example: { row: "1", col: "1" }, defaults: { row: "1", col: "1" } },
  ...
  { type: "CSI", code: "W", mnemonic: "CTC", description: "cursor tabulation control", params: { "0": "set horizontal tab at active position", "1": "set vertical tab at active line", "2": "clear horizontal tab at active position", "3": "clear vertical tab at active line", "4": "clear all horizontal tabs at active line", "5": "clear all horizontal tabs", "6": "clear all vertical tabs" }, defaults: { mode: "0" } },
  ...
  { type: "CSI", code: "`", mnemonic: "HPA", description: "horizontal position absolute", template: "col <col>", example: { col: "1" }, defaults: { col: "1" } },
  { type: "CSI", code: "a", mnemonic: "HPR", description: "horizontal position relative", template: "<cols> cols", example: { cols: "1" }, defaults: { cols: "1" } },
  { type: "CSI", code: "b", mnemonic: "REP", description: "repeat character", template: "<n> times", example: { n: "1" }, defaults: { n: "1" } },
  { type: "CSI", code: "c", mnemonic: "DA", description: "device attributes", params: { "0": "request primary device attributes", ">0": "request secondary device attributes" }, defaults: { mode: "0" } },
  { type: "CSI", code: "d", mnemonic: "VPA", description: "vertical position absolute", template: "row <row>", example: { row: "1" }, defaults: { row: "1" } },
  { type: "CSI", code: "e", mnemonic: "VPR", description: "vertical position relative", template: "<rows> rows", example: { rows: "1" }, defaults: { rows: "1" } },
  { type: "CSI", code: "f", mnemonic: "HVP", description: "horizontal vertical position", template: "row <row>, col <col>", example: { row: "1", col: "1" }, defaults: { row: "1", col: "1" } },
  ...
  { type: "CSI", code: "i", mnemonic: "MC", description: "media copy (printer control)", params: { "0": "print screen", "4": "turn off printer controller mode", "5": "turn on printer controller mode" }, defaults: { mode: "0" } },
  { type: "CSI", code: "j", mnemonic: "HPB", description: "horizontal position backward", template: "<cols> cols", example: { cols: "1" }, defaults: { cols: "1" } },
  { type: "CSI", code: "k", mnemonic: "VPB", description: "vertical position backward", template: "<rows> rows", example: { rows: "1" }, defaults: { rows: "1" } },
  ...
  { type: "CSI", code: "n", mnemonic: "DSR", description: "device status report", params: { "5": "status report", "6": "report cursor position", R: "report cursor position response", "0": "ready" }, defaults: { mode: "0" } },
  ...
  { type: "CSI", code: "o", mnemonic: "DAQ", description: "define area qualification", params: { "0": "unprotected", "1": "guarded (protected)", "2": "graphic character input", "3": "numeric input", "4": "alphabetic input", "5": "input justified right", "6": "fill with zeros", "7": "set horizontal tab", "8": "protected (unguarded)", "9": "fill with spaces" }, defaults: { mode: "0" } },
  ...
  { type: "CSI", code: '"q', mnemonic: "DECSCA", description: "select character protection attribute", template: "<attr>", example: { attr: "1" } },
