...
export const controlCodes: ControlCodeItem[] = [
  ...
  { type: "CSI", code: "h", mnemonic: "SM", description: "set mode", params: { "4": "insert mode (IRM)", "20": "automatic newline (LNM)" }, defaults: { mode: "4" } },
  { type: "CSI", code: "l", mnemonic: "RM", description: "reset mode", params: { "4": "replace mode (IRM)", "20": "normal linefeed (LNM)" }, defaults: { mode: "4" } },
  { type: "CSI", code: "m", mnemonic: "SGR", description: "select graphic rendition", defaults: { attribute: "0" } },
  { type: "CSI", code: "n", mnemonic: "DSR", description: "device status report", params: { "5": "status report", "6": "report cursor position", R: "report cursor position response", "0": "ready" }, defaults: { mode: "5" } },
